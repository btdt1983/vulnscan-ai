...
export DEEPSEEK_API_KEY=...              # deepseek (DeepSeek V4.1 Flash)
export MISTRAL_API_KEY=...               # mistral (Mistral Small 4)
...
`--model` (e.g. `deepseek-flash`, `mistral-large-latest`). **StarCoder 2** has no
